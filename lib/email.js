...
SCFC Team
  ...
  try {
    ...
    if (error) {
      ...
      return {
        success: false,
        error: error.message || 'Failed to send password reset email via Resend'
      };
    }
...
SCFC Team
  ...
  try {
    ...
    if (error) {
      ...
      return {
        success: false,
        error: error.message || 'Failed to send verification email via Resend'
      };
    }
...
SCFC Team
  ...
  try {
    ...
    if (error) {
      ...
      return {
        success: false,
        error: error.message || 'Failed to send change email verification via Resend'
      };
    }
